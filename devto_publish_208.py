#!/usr/bin/env python3
"""dev.to #208 publisher - SSO outage runbook via API rail."""
import json, urllib.request
KEY_PATH = "/Users/haroonqamer/Swarm/hive/state/secure/devto_api_key.txt"
ART_PATH = "/Users/haroonqamer/Swarm/hive/state/revenue/devto_208_sso_outage.md"
...
def main():
    ...
    assert body.startswith('---'), "front matter must open with --- delimiter"
